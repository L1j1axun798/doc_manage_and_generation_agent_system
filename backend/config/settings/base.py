...
env = environ.Env(
    ...
    AMAP_WEB_SERVICE_TIMEOUT_SECONDS=(int, 10),
    ...
    WEBAUTHN_ENROLLMENT_TICKET_TTL_SECONDS=(int, 10800),
    WEBAUTHN_ALLOW_SYNCED_PASSKEYS=(bool, True),
    API_REQUIRE_WEBAUTHN_SESSION=(bool, True),
    LOGIN_REQUIRE_WEBAUTHN=(bool, True),
    LOCATION_REPORT_REQUIRE_WEBAUTHN=(bool, True),
...
AMAP_WEB_SERVICE_KEY = env("AMAP_WEB_SERVICE_KEY")
AMAP_WEB_SERVICE_TIMEOUT_SECONDS = env("AMAP_WEB_SERVICE_TIMEOUT_SECONDS")
...
WEBAUTHN_ALLOW_SYNCED_PASSKEYS = env("WEBAUTHN_ALLOW_SYNCED_PASSKEYS")
# Fall back to the former combined switch during rolling upgrades. An explicit
# LOGIN_REQUIRE_WEBAUTHN value always takes precedence.
LEGACY_API_REQUIRE_WEBAUTHN_SESSION = env("API_REQUIRE_WEBAUTHN_SESSION")
LOGIN_REQUIRE_WEBAUTHN = env(
    "LOGIN_REQUIRE_WEBAUTHN",
    default=LEGACY_API_REQUIRE_WEBAUTHN_SESSION,
)
LOCATION_REPORT_REQUIRE_WEBAUTHN = env("LOCATION_REPORT_REQUIRE_WEBAUTHN")
